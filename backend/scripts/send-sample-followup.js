#!/usr/bin/env node
/**
 * Send the sample-chapter nurture follow-up.
 *
 * Default delay: 3 days after lastRequestedAt (short lead-magnet best practice).
 * Skips anyone who already purchased (paid digital/paperback) or already received
 * sampleFollowUpEmailSentAt.
 *
 * Usage:
 ...
 *   SAMPLE_REQUESTS_TABLE=... ORDERS_TABLE=... node scripts/send-sample-followup.js --days 3
