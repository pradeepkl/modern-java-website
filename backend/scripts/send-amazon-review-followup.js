#!/usr/bin/env node
/**
 * Send the Amazon buying-intent follow-up to Classpath Reader List members who:
 * - opted in via amazon_exit_modal / amazon-pre-navigation
 * - still have marketingConsent === true
 * - opted in at least --days ago (default 3)
 ...
 *   SAMPLE_REQUESTS_TABLE=... node scripts/send-amazon-review-followup.js --days 5
