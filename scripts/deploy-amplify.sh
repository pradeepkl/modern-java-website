...
export VITE_DIGITAL_SALES_ENABLED="${VITE_DIGITAL_SALES_ENABLED:-false}"
...
if [[ "${SKIP_BUILD:-0}" != "1" ]]; then
  ...
  echo "    VITE_DIGITAL_SALES_ENABLED=${VITE_DIGITAL_SALES_ENABLED}"
  ...
  build_env=(
    ...
    "VITE_DIGITAL_SALES_ENABLED=${VITE_DIGITAL_SALES_ENABLED}"
  )
